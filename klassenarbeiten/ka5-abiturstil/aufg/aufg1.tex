...
\begin{subparts}
	...
	\subpart[3] Gib an \ldots\ falls:\droppoints
\begin{subsubparts}
	\subsubpart die Geschwindigkeit $v = \qty{10}{\kmh}$ beträgt.
	\subsubpart die Geschwindigkeit $v = \qty{15.5}{\kmh}$ beträgt.
	\subsubpart die Geschwindigkeit $v = \qty{20}{\kmh}$ beträgt.
\end{subsubparts}
\end{subparts}
\begin{EnvUplevel}
