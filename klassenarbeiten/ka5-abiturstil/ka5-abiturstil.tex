...
\renewcommand{\thesubpart}{\arabic{subpart}}% Unteraufgaben numeriert,
% und Unteraufgaben dann gedruckt als 1.1.1 :
...
%% Aufgabe 2
% Zweite Aufgabe ---
\titledquestion{Titel der zweiten Aufgabe}\label{ques:dieeineaufg}
\begin{parts}
...
\end{equation}
	\part[1] Mit \textbackslash{}label und \textbackslash{}ref können die Aufgaben wie üblich referenziert werden, wie hier z.B. die Aufgabe~\ref{ques:dieeineaufg}.\droppoints
\end{parts}
% Ende Aufgabe.
